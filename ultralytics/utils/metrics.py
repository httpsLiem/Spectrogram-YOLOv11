...
#
#
# def bbox_iou(box1, box2, xywh=True, GIoU=False, DIoU=False, CIoU=False, UIoU=False, eps=1e-7):
#     """
#     Calculates the Intersection over Union (IoU) between bounding boxes.
#
#     This function supports various shapes for `box1` and `box2` as long as the last dimension is 4.
...
#             ratio = -0.003 * epoch + 2
#         elif cosine:
#             ratio = 0.75 * math.cos(math.pi * epoch / 500) + 1.25
#         elif fraction:
#             ratio = 300 / (epoch + 200)
#         else:
#             ratio = 0.5
#         ww1, hh1, ww2, hh2 = w1 * ratio, h1 * ratio, w2 * ratio, h2 * ratio
#         bb1_x1, bb1_x2, bb1_y1, bb1_y2 = bb1_xc - (ww1 / 2), bb1_xc + (ww1 / 2), bb1_yc - (hh1 / 2), bb1_yc + (
#                     hh1 / 2)
#         bb2_x1, bb2_x2, bb2_y1, bb2_y2 = bb2_xc - (ww2 / 2), bb2_xc + (ww2 / 2), bb2_yc - (hh2 / 2), bb2_yc + (
#                     hh2 / 2)
